 ...
 * resources/web/nuxeo.war/scripts/nuxeo-skyscanner-image-cropper.js)
 *
 * @since 7.1
 */
@Name("skyscannerImageCropHelper")
@Scope(ScopeType.EVENT)
public class SkyScannerImageCropHelperBean implements Serializable {
    ...
    private static final Log log = LogFactory.getLog(SkyScannerImageCropHelperBean.class);
